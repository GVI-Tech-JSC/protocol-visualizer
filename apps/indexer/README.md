...
This package contains the Tech Holding JSC protocol visualizer indexer. The runtime is
Envio HyperIndex.

## What It Indexes

The indexer tracks Tech Holding JSC Kernel, ROLES, and RolesAdmin events across the
